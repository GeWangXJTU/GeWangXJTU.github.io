...
### Journal Reviewer:
  * IEEE Transactions on Mobile Computing (TMC) <span style="color: #FF0000;">**(CCF-A)**</span>
  * IEEE Transactions on Networking (ToN)  <span style="color: #FF0000;">**(CCF-A)**</span>
  * IEEE Transactions on Information Forensics and Security (TIFS) <span style="color: #FF0000;">**(CCF-A)**</span>
  * Proceedings of the ACM on Interactive, Mobile, Wearable and Ubiquitous Technologies (ACM IMWUT)  <span style="color: #FF0000;">**(CCF-A)**</span>
  * IEEE Journal of Internet of Things (IoT-J) <span style="color: #FF0000;">**(Q1)**</span>
  * ACM Transactions on Sensor Networks (TOSN) <span style="color: #0000FF;">**(CCF-B)**</span>
  * EURASIP Journal on Wireless Communications and Networking  <span style="color: #FF0000;">**(Q1)**</span>
  * ACM Transactions on Multimedia Computing Communications and Applications (TOMM) <span style="color: #FF0000;">**(Q1)**</span>
  * Digital Communications and Networks (IF=6.797)
  * Computer Networks (IF=5.493)
  * Journal of Cloud Computing (IF=3.19)


### Conference Reviewer:
  * ICML 2026 <span style="color: #FF0000;">**(CCF-A)**</span>
  * AAAI 2025 <span style="color: #FF0000;">**(CCF-A)**</span>
  * IJCAI 2025 <span style="color: #FF0000;">**(CCF-A)**</span>
  * INFOCOM 2023, 2024 <span style="color: #FF0000;">**(CCF-A)**</span>
